...
const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({ billboards, userId }) => {
  ...
  const getMonthlyEarnings = () => {
    ...
    return Object.entries(months).map(([name, earnings]) => ({
      name,
      earnings,
    }));
  };
        ...
        <Card className="bg-gradient-to-br from-[#9BFF43]/20 to-[#9BFF43]/5 border-[#9BFF43]/20 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              {pendingEarnings > 0 && (
                <p className="text-sm text-[#9BFF43] mt-1">
        ...
        <Card className="bg-[#1E1E1E] border-white/10 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-white/40 mt-1">
                {billboards.length} espectaculares
              </p>
            </div>
            <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/10">
                ...
                <th className="text-center py-3 px-4 text-white/60 font-medium text-sm">Estado</th>
              </tr>
            </thead>
            <tbody>
