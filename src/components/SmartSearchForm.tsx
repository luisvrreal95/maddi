...
const SmartSearchForm: React.FC<SmartSearchFormProps> = ({ onSearch }) => {
  ...
  return (
    <div className="flex w-full max-w-[650px] flex-col items-center gap-4 mx-auto max-md:max-w-[580px] max-sm:max-w-[95%]">
      ...
      <div className="relative w-full">
        <form
          ...
          className="flex justify-between items-center gap-3 self-stretch border bg-[rgba(255,255,255,0.03)] px-8 py-5 rounded-[100px] border-solid border-[rgba(255,255,255,0.25)] max-sm:gap-2 max-sm:px-6 max-sm:py-4"
          style={{
        ...
        >
          ...
          <button
            type="submit"
            className="flex w-12 h-12 justify-center items-center shrink-0 bg-[rgba(255,255,255,0.08)] rounded-full max-sm:w-10 max-sm:h-10 hover:bg-[rgba(255,255,255,0.15)] transition-colors"
            aria-label="Buscar"
          >
            {isNaturalLanguageQuery ? (
        ...
        {/* Suggestions dropdown - positioned absolutely below form */}
