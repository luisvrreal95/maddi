...
const Auth: React.FC = () => {
      ...
      <div className="min-h-screen bg-card flex items-center justify-center p-8">
        <div className="max-w-md w-full text-center">
          ...
          <Button
            ...
            className="bg-primary text-primary-foreground hover:bg-[#8AE63A] px-8"
          >
            Ir a iniciar sesión
          </Button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-card flex">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-primary text-primary-foreground hover:bg-[#8AE63A] font-semibold h-12 rounded-xl text-base transition-all duration-200 hover:shadow-lg hover:shadow-primary/30"
            >
              {isLoading 
                ? 'Procesando...' 
                : mode === 'login' 
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-primary/10 via-[#1A1A1A] to-primary/5 relative overflow-hidden items-center justify-center">
        {/* Central content */}
        <div className="text-center max-w-lg px-12 relative z-10">
          <div className="w-40 h-40 bg-gradient-to-br from-primary to-[#7ACC35] rounded-[2rem] mx-auto mb-10 flex items-center justify-center shadow-2xl shadow-primary/30 rotate-3 hover:rotate-0 transition-transform duration-500">
